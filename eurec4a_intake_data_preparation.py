...
path_out = '/Volumes/Extreme SSD/ship_motion_correction_merian/corrected_data/eurec4a_intake/'
...
for indDay in range(NdaysEurec4a):
    ...
    WbandData = xr.Dataset(
        data_vars={
            "rain_rate": (('time',), rr, {'long_name': 'rain rate', 'units':'mm h-1', "standard_name": "rainfall_rate"}),
            ...
            'mean_doppler_velocity':(('time','height'), vd, {'long_name': 'mean Doppler velocity corrected smoothed', 'units':'m s-1'}),
            'radar_reflectivity':(('time','height'), ze, {'long_name': 'radar reflectivity', 'units':'dBz'}),
        ...
        coords={
            ...
            "height": (('height',), height, {"axis": "Z","positive": "up","units": "m", "long_name":'radar range height'}),
