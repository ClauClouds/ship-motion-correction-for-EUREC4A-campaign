...
listDaysNonProcessed = [datetime(2020,2,2), datetime(2020,2,3)]
...
for indDayEu in range(NdaysEurec4a):
    ...
    windFile     = '/Volumes/Extreme SSD/ship_motion_correction_merian/wind_data_iconlem/'+yy+mm+dd+'_ICON_LEM_wind_dataset.nc'
    ...
    absWindSpeed = windData['speed'].values     
    absWindDir   = windData['direction'].values  
